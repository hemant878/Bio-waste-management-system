...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="/e11/index.html">Bio-Medical Waste Management</a>
      ...
      <!--    <li class="nav-item dropdown">
        ...
        <form method="POST" action="#" class="d-flex" class="py-7 bg-light border">
...
<ul class="nav nav-tabs nav-fill">
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">Yellow Waste</a>
    </li>
    <li class="nav-item">
...
<table  class="table table-striped my-5 "> 
            ...
            while($rows=$re->fetch_assoc()){  ?>
                <tr>
                <td class="table-warning"><?php echo $rows['type'];?></td> 
                <td class="table-warning"><?php echo $rows['date'];?></td> 
                <td class="table-warning" class="table-danger"><?php echo $rows['equipment'];?></td> 
            <!--    <td class="table-warning"><?php //echo $rows['quantity'];?></td>  -->
                ...
                <td class="table-warning text-white"><a href="delete.php?id=<?php echo $rows['id'];?>">Delete</a></td>
                </tr>
<?php
            } ?>

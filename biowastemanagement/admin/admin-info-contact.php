...
<ul class="nav nav-tabs nav-fill">
    ...
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="admin-info-contact.php">contact</a>
    </li>
    <li class="nav-item">
...
<table class="table table-striped my-5 "> 
            ...
            while($rows=$re->fetch_assoc()){  ?>
                ...
                <td><a href="delete-contact.php?id=<?php echo $rows['id'];?>">Delete</a></td>
                </tr>
<?php
            } ?>

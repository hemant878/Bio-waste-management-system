...
<?php
$info="SELECT * FROM `form` WHERE `equipment`='Needles' OR `equipment`='Burner' OR `equipment`='Scalpels' OR `equipment`='Blades' OR `equipment`='Discarded Metal Sharp' OR `equipment`='Cutter'OR `equipment`='Lancets'";
$re=$connect->query($info);
$connect->close();
?>
...
<ul class="nav nav-tabs nav-fill">
    ...
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">White Waste</a>
    </li>
    <li class="nav-item">
...
<table class="table table-striped my-5 "> 
           ...
           <!--     <td><?php //echo $rows['quantity'];?></td>  -->
                ...
                <td><?php echo $rows['p_condition'];?></td> 

...
<ul class="nav nav-tabs nav-fill">
    ...
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">Blue Waste</a>
    </li>
    <li class="nav-item">
...
<table class="table table-striped my-5   "> 
          ...
          <!--      <th>Quantity</th>  -->
            ...
            while($rows=$re->fetch_assoc()){  ?>
                <tr>
                <td class="table-primary"><?php echo $rows['type'];?></td>
                <td class="table-primary"><?php echo $rows['date'];?></td>
             ...
             <!--   <td class="table-primary"><?php //echo $rows['quantity'];?></td> -->
                ...
                <td class="table-primary"><a href="delete.php?id=<?php echo $rows['id'];?>">Delete</a></td>

...
<?php
$large="SELECT * FROM `form` WHERE `equipment`='Cotton Swabs' OR `equipment`='Discarded Medicines' OR `equipment`='Blood Bags'";
$re=$connect->query($large);
$connect->close();
?>
...
<ul class="nav nav-tabs nav-fill">
    <li class="nav-item">
        <a class="nav-link active bg-warning text-dark" aria-current="page" href="#">Yellow Waste</a>
    </li>
    <li class="nav-item">
...
<center><h2 style="margin: 10px 0 10px 0"> Yellow Category Bio-Medical Waste  </h2></center>
<a href="company-form.php"><button type="button" class="btn btn-warning text-dark my-2" style="margin:0px 0 0 20px"> Buying Form</button></a>
<table class="table table-striped"> 
          ...
          <!--      <th>Quantity</th> -->
            ...
            while($rows=$re->fetch_assoc()){  ?>
                <tr>
                <td class="table-warning"><?php echo $rows['equipment'];?></td> 
             <!--   <td class="table-warning"><?php //echo $rows['quantity'];?></td> -->
                <td class="table-warning"><?php echo $rows['weight']." kg";?></td>
                <td class="table-warning"><?php echo $rows['p_description'];?></td> 
                <td class="table-warning"><?php echo $rows['p_condition'];?></td> 
                <td class="table-warning"><?php echo $rows['email'];?></td> 
                </tr>
<?php
            } ?>
